...
for (k in 1:750) {
  ...
  dbox=rep(NA,m)
  for(j in 1:m) {
    xn1=a[1]+ a[2]*xn + a[3]*(xn)^2 + a[4]*(xn*yn) + a[5]*yn+a[6]*abs(yn)
    yn1=a[7]+ a[8]*xn + a[9]*abs(xn) + a[10]*(xn*yn) + a[11]*yn+a[12]*(yn)^2
    xm1=a[1]+ a[2]*xm + a[3]*(xm)^2 + a[4]*(xm*ym) + a[5]*ym+a[6]*abs(ym)
    ym1=a[7]+ a[8]*xm + a[9]*abs(xm) + a[10]*(xm*ym) + a[11]*ym+a[12]*(ym)^2
